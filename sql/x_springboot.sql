...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RenrenScheduler', 'CIFX5T2TRH4ZE3H1553440432136', 1553441104783, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RenrenScheduler', 'TASK_1', 'DEFAULT', 'TASK_1', 'DEFAULT', NULL, 1553441400000, -1, 5, 'WAITING', 'CRON', 1553440433000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RenrenScheduler', 'TASK_2', 'DEFAULT', 'TASK_2', 'DEFAULT', NULL, 1553441400000, -1, 5, 'PAUSED', 'CRON', 1553440433000, 0, NULL, 2, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统配置信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_config
-- ----------------------------
INSERT INTO `sys_config` VALUES (1, 'CLOUD_STORAGE_CONFIG_KEY', '{\"aliyunAccessKeyId\":\"\",\"aliyunAccessKeySecret\":\"\",\"aliyunBucketName\":\"\",\"aliyunDomain\":\"\",\"aliyunEndPoint\":\"\",\"aliyunPrefix\":\"\",\"qcloudBucketName\":\"\",\"qcloudDomain\":\"\",\"qcloudPrefix\":\"\",\"qcloudSecretId\":\"\",\"qcloudSecretKey\":\"\",\"qiniuAccessKey\":\"NrgMfABZxWLo5B-YYSjoE8-AZ1EISdi1Z3ubLOeZ\",\"qiniuBucketName\":\"ios-app\",\"qiniuDomain\":\"http://7xqbwh.dl1.z0.glb.clouddn.com\",\"qiniuPrefix\":\"upload\",\"qiniuSecretKey\":\"uIwJHevMRWU0VLxFvgy0tAcOdGqasdtVlJkdy6vV\",\"type\":1}', 0, '云存储配置信息');
INSERT INTO `sys_config` VALUES (2, 'zuidaima', 'zuidama.com', 1, '最代码域名');
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (1, 'admin', '保存配置', 'com.suke.czx.modules.sys.controller.SysConfigController.save()', '{\"key\":\"zuidaima\",\"value\":\"zuidama.com\",\"remark\":\"最代码域名\"}', 90, '0:0:0:0:0:0:0:1', '2019-03-24 23:19:26');
INSERT INTO `sys_log` VALUES (2, 'admin', '保存角色', 'com.suke.czx.modules.sys.controller.SysRoleController.save()', '{\"roleId\":1,\"roleName\":\"最代码管理员\",\"remark\":\"zuidaima.com的管理\",\"createUserId\":1,\"menuIdList\":[],\"createTime\":\"Mar 24, 2019 11:20:09 PM\"}', 28, '0:0:0:0:0:0:0:1', '2019-03-24 23:20:09');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '最代码管理员', 'zuidaima.com的管理', 1, '2019-03-24 23:20:09');
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES (1, '1d466f9c5c79866f1017e960ba869a7c', '2019-03-25 11:15:44', '2019-03-24 23:15:44');
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'APP版本管理' ROW_FORMAT = Compact;
